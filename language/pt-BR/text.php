...
$hesklang['attachment_viewer_message']='Arraste os arquivos aqui ou clique nothe \'Adicionar aquivo\' botão abaixo para selecionar arquivos para enviar.';
...
// ASSET MANAGEMENT
$hesklang['assets_management']='Gestão de ativos';
$hesklang['components']='Componentes';
$hesklang['computers']='Computadores';
$hesklang['monitors']='Monitores';
$hesklang['printers']='Impressoras';
$hesklang['departments']='Departamentos';
$hesklang['customers']='Clientes';
$hesklang['menu_computers']='Computadores';
$hesklang['asset_intro_computers']='Aqui você pode gerenciar computadores ativos. Você pode editar
e excluir qualquer computador pelos ícones na seção &quot;Ações&quot;. Sempre que
você editar ou adicionar um novo computador, também poderá adicionar novos componentes diretamente nesta página,
mas não poderá excluir ou editar nenhum componente por aqui (acesse o menu Componentes para mais informações).';
$hesklang['add_computer']='Novo computador';
$hesklang['mac_address']='Endereço MAC';
$hesklang['computer_name']='Nome do computador';
$hesklang['customer']='Cliente';
$hesklang['cpu']='CPU';
$hesklang['gpu']='GPU';
$hesklang['ram']='RAM';
$hesklang['font']='Fonte';
$hesklang['disk']='Disco';
$hesklang['internal']='Interno';
$hesklang['desktop']='Desktop';
$hesklang['protected']='Protegido';
$hesklang['actions']='Ações';
$hesklang['integrated']='Integrada';
$hesklang['dedicated']='Dedicada';
$hesklang['empty']='Vazio';
$hesklang['no_data_found']='Nenhum dado encontrado';
$hesklang['not_original']='Essa funcionalidade não faz parte do software original!';
$hesklang['asset_not_found']='Ativo não encontrado';
$hesklang['edit_computer']='Editar computador';
$hesklang['create_computer']='Criar computador';
$hesklang['select_customer']='Selecionar cliente';
$hesklang['select_cpu']='Selecionar CPU';
$hesklang['select_mb']='Selecionar placa-mãe';
$hesklang['select_disk']='Selecionar disco';
$hesklang['select_font']='Selecionar fonte';
$hesklang['save_computer']='Salvar computador';
$hesklang['fill_required']='Preencha os campos necessários';
$hesklang['select_required']='Selecione os campos necessários';
$hesklang['computer_added']='Computador adicionado!';
$hesklang['computer_updated']='Computador atualizado!';
$hesklang['purchase_date']='Data de compra';
$hesklang['warranty_until']='Garantia até';
$hesklang['department']='Setor';
$hesklang['model']='Modelo';
$hesklang['cores']='Cores';
$hesklang['threads']='Threads';
$hesklang['size_gb']='Tamanho (GB)';
$hesklang['speed_mhz']='Velocidade (MHz)';
$hesklang['type']='Tipo';
$hesklang['interface']='Interface';
$hesklang['capacity_gb']='Capacidade (GB)';
$hesklang['speed_rpm']='Velocidade (RPM)';
$hesklang['max_ram_gb']='RAM Máxima (GB)';
$hesklang['ram_slots']='Slots de RAM';
$hesklang['max_speed']='Velocidade Máxima (MHz)';
$hesklang['chipset']='Chipset';
$hesklang['wattage']='Tensão (W)';
$hesklang['bivolt']='Bivolt';
$hesklang['ram_modules']='Modulos de RAM';
$hesklang['power_supplies']='Fontes de Alimentação';
$hesklang['add_new_component']='Adicionar novo componente';
$hesklang['edit_component']='Editar componente';
$hesklang['view_component']='Visualizar componente';
$hesklang['create_component']='Criar componente';
$hesklang['components']='Componentes';
$hesklang['ram_max_storage_gb']='RAM Máxima (GB)';
$hesklang['ram_max_speed_mhz']='Velocidade Máxima da RAM (MHz)';
$hesklang['network_iface']='Interface de Rede';
$hesklang['usb_ports']='Quantidade de Portas USB';
$hesklang['video_ports']='Portas de Vídeo';
$hesklang['storage_ifaces']='Tipos de Interface de Armazenamento';
$hesklang['is_bivolt']='Bivolt';
$hesklang['wattage_w']='Tensão (W)';
$hesklang['create']='Criar';
$hesklang['invalid_type']='Tipo de ativo inválido';
$hesklang['delete_confirm']='Confirmar deletar';
$hesklang['ethernet']='Ethernet';
$hesklang['wifi']='WiFi';
$hesklang['ram_has_inactive']='Modulos de RAM inativos';
$hesklang['disk_has_inactive']='Modulos de disco inativos';
$hesklang['mb_is_inactive']='Placa-mãe está inativa';
$hesklang['psu_is_inactive']='Fonte de Alimentação está inativa';
$hesklang['cpu_is_inactive']='CPU está inativo';
$hesklang['department_is_inactive']='Setor está inativo';
$hesklang['customer_is_inactive']='Cliente está inativo';
$hesklang['add_new_department']='Adicionar novo setor';
$hesklang['computer']='Computador';
$hesklang['add_new_customer']='Adicionar novo cliente';
$hesklang['customer_added']='Cliente adicionado!';
$hesklang['customer_updated']='Cliente atualizado!';
$hesklang['security']='Segurança';
$hesklang['os_version']='Versão SO';
$hesklang['os_name']='Nome SO';
$hesklang['os']='SO';
$hesklang['asset_tag']='TAG de ativo';
$hesklang['inactive_removed']='Inativos removidos do computador';
$hesklang['confirm_remove_inactive']='Remover componentes inativos?';
$hesklang['view_details'] = 'Ver detalhes do computador';
$hesklang['updated_at'] = 'Atualizado';
$hesklang['created_at'] = 'Criado';
$hesklang['ip_mac']='IP/MAC';
$hesklang['local']='Local';
$hesklang['add_new_printer']='Adicionar nova impressora';
$hesklang['printer_deleted']='Impressora deletada';
$hesklang['printer_not_found']='Impressora não encontrada';
$hesklang['printer_deleted']='Impressora deletada com sucesso';
$hesklang['edit_printer']='Editar impressora';
$hesklang['printer_type']='Tipo de Impressora';
$hesklang['local']='Local';
$hesklang['network']='Rede';
$hesklang['p_model_req']='Modelo da impressora é obrigatório';
$hesklang['invalid_ip']='Formato de endereço IP inválido';
$hesklang['printer_updated']='Impressora %s atualizada com sucesso';
$hesklang['printer_added']='Impressora %s adicionada com sucesso';
$hesklang['monitors']='Monitores';
$hesklang['add_new_monitor']='Adicionar novo monitor';
$hesklang['update_hz']='Taxa de Atualização Hz';
$hesklang['size_in']='Tamanho (polegadas)';
$hesklang['edit_customer']='Editar cliente';
$hesklang['create_customer']='Criar cliente';

// CUSTOM CODE BY 'diogowermann'
$hesklang['assets_management']="Ativos";
$hesklang['components']="Componentes";
$hesklang['computers']="Computadores";
$hesklang['monitors']="Monitores";
$hesklang['printers']="Impressoras";
...
$hesklang['customers']="Clientes";
$hesklang['menu_computers']="Computadores";
$hesklang['asset_intro_computers']="Aqui você pode gerenciar computadores ativos. Você pode editar e excluir qualquer Computador pelos botões. Sempre que editar ou adicionar um novo Computador, também poderá adicionar novos Componentes diretamente nesta página, mas não pode excluir ou editar nenhum Componente aqui (acesse o menu Componentes para mais informações).";
$hesklang['add_computer']="Adicionar computador";
$hesklang['mac_address']="Endereço MAC";
$hesklang['computer_name']="Nome do computador";
$hesklang['customer']="Cliente";
$hesklang['motherboard']="Placa-mãe";
$hesklang['cpu']="CPU";
$hesklang['gpu']="GPU";
$hesklang['rams']="RAM";
$hesklang['psu']="Fonte de alimentação";
$hesklang['disks']="Discos";
$hesklang['internal']="Interno";
$hesklang['desktop']="Desktop";
$hesklang['protected']="Protegido";
$hesklang['actions']="Ações";
$hesklang['integrated']="Integrado";
$hesklang['dedicated']="Dedicado";
$hesklang['empty']="Vazio";
$hesklang['no_data_found']="Nenhum dado encontrado";
$hesklang['not_original']="Este recurso não faz parte do software original!";
$hesklang['asset_not_found']="Ativo não encontrado";
$hesklang['edit_computer']="Editar computador";
$hesklang['create_computer']="Criar computador";
$hesklang['select_customer']="Selecione o cliente";
$hesklang['select_cpu']="Selecione a CPU";
$hesklang['select_mb']="Selecione a placa-mãe";
$hesklang['select_disk']="Selecione o disco";
$hesklang['select_font']="Selecione a fonte";
$hesklang['save_computer']="Salvar computador";
$hesklang['fill_required']="Preencha os campos obrigatórios";
$hesklang['select_required']="Selecione os campos obrigatórios";
$hesklang['computer_added']="Computador adicionado!";
$hesklang['computer_updated']="Computador atualizado!";
$hesklang['purchase_date']="Data de compra";
$hesklang['warranty_until']="Garantia até";
$hesklang['department']="Departamento";
$hesklang['model']="Modelo";
$hesklang['cores']="Núcleos";
$hesklang['threads']="Threads";
$hesklang['size_gb']="Tamanho (GB)";
$hesklang['speed_mhz']="Velocidade (MHz)";
$hesklang['type']="Tipo";
...
$hesklang['max_speed']="Velocidade máxima (MHz)";
$hesklang['chipset']="Chipset";
$hesklang['wattage']="Potência (W)";
$hesklang['bivolt']="Bivolt";
$hesklang['ram_modules']="Módulos de RAM";
$hesklang['power_supplies']="Fontes de alimentação";
$hesklang['add_new_component']="Adicionar novo componente";
$hesklang['edit_component']="Editar componente";
$hesklang['view_component']="Ver componente";
$hesklang['create_component']="Criar componente";
$hesklang['network_iface']="Interface de rede";
$hesklang['storage_ifaces']="Tipos de interfaces de armazenamento";
$hesklang['is_bivolt']="Bivolt";
$hesklang['wattage_w']="Potência (W)";
$hesklang['create']="Criar";
$hesklang['invalid_type']="Tipo de ativo inválido";
$hesklang['delete_confirm']="Confirmar exclusão";
$hesklang['cable']="Cabo";
$hesklang['wifi']="Wi-Fi";
$hesklang['ram_has_inactive']="A RAM possui módulos inativos";
$hesklang['disk_has_inactive']="O disco possui módulos inativos";
$hesklang['mb_is_inactive']="A placa-mãe está inativa";
$hesklang['psu_is_inactive']="A fonte de alimentação está inativa";
$hesklang['cpu_is_inactive']="A CPU está inativa";
$hesklang['department_is_inactive']="O departamento está inativo";
$hesklang['customer_is_inactive']="O cliente está inativo";
$hesklang['add_new_department']="Adicionar novo departamento";
$hesklang['computer']="Computador";
$hesklang['add_new_customer']="Adicionar novo cliente";
$hesklang['customer_added']="Cliente adicionado!";
$hesklang['customer_updated']="Cliente atualizado!";
$hesklang['security']="Segurança";
$hesklang['os_version']="Versão do SO";
$hesklang['os_name']="Nome do SO";
$hesklang['os']="SO";
$hesklang['asset_tag']="TAG do ativo";
$hesklang['inactive_removed']="Inativos removidos do computador";
$hesklang['confirm_remove_inactive']="Remover componentes inativos?";
$hesklang['view_details']="Ver detalhes do computador";
$hesklang['updated_at']="Atualizado em";
$hesklang['created_at']="Criado em";
$hesklang['ip_mac']="IP/MAC";
$hesklang['local']="Local";
$hesklang['add_new_printer']="Adicionar nova impressora";
$hesklang['printer_deleted']="Impressora excluída";
$hesklang['printer_not_found']="Impressora não encontrada";
$hesklang['printer_deleted']="Impressora excluída com sucesso";
$hesklang['edit_printer']="Editar impressora";
$hesklang['printer_type']="Tipo de impressora";
$hesklang['network']="Rede";
$hesklang['p_model_req']="Modelo da impressora é obrigatório";
...
$hesklang['printer_added']="Impressora %s adicionada com sucesso";
$hesklang['add_new_monitor']="Adicionar novo monitor";
$hesklang['update_hz']="Atualizar Hz";
$hesklang['size_in']="Tamanho (polegadas)";
$hesklang['edit_customer']="Editar cliente";
$hesklang['create_customer']="Criar cliente";
$hesklang['ghz']="GHz";
