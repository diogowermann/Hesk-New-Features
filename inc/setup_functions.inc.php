...
function hesk_testMySQL()
{
	...
	$tables = array(
        ...
        $set['db_pfix'].'users',
        // CUSTOM
        $set['db_pfix'].'computers',
        $set['db_pfix'].'computers_cpu',
        $set['db_pfix'].'computers_ram',
        $set['db_pfix'].'computers_disk',
        $set['db_pfix'].'computers_font',
        $set['db_pfix'].'computers_mb',
        $set['db_pfix'].'monitors',
        $set['db_pfix'].'printers',
        $set['db_pfix'].'user_clients',
	);
