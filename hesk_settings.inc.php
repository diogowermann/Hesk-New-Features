...
// --> General settings
$hesk_settings['site_title']='Página Inicial';
$hesk_settings['site_url']='https://glpi.launer.com.br/';
$hesk_settings['hesk_title']='Chamado Testes';
$hesk_settings['hesk_url']='https://glpi.launer.com.br/chamado';
$hesk_settings['webmaster_mail']='ti@launer.com.br';
...
$hesk_settings['secimg_sum']='A1YQ83ZYUR';
...
$hesk_settings['question_ask']='Which of these is not an animal: dog, mouse, money';
$hesk_settings['question_ans']='money';
...
$hesk_settings['url_key']='dgfr0yhBgp-Txn._efERT3GZPaAg';
...
// --> Email sending
$hesk_settings['noreply_mail']='ti@launer.com.br';
$hesk_settings['noreply_name']='Ti-Launer';
$hesk_settings['email_formatting']=3;
$hesk_settings['smtp']=1;
$hesk_settings['smtp_host_name']='mail-ssl.m9.network';
$hesk_settings['smtp_host_port']=587;
$hesk_settings['smtp_timeout']=200;
$hesk_settings['smtp_enc']='tls';
$hesk_settings['smtp_noval_cert']=0;
$hesk_settings['smtp_user']='ti@launer.com.br';
$hesk_settings['smtp_password']='LAUR2019*sjh';
...
$hesk_settings['format_date']='d/m/Y';
$hesk_settings['format_timestamp']='d/m/Y H:i:s';
